...
public class MetadataRewriteInCompanionTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer companionLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/companion_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/companion_app", "main"))
