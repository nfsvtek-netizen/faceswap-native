...
public class MetadataRewriteInFunctionTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer funLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/function_lib", "B"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/function_app", "main"))
