...
public class MetadataRewriteInTypeArgumentsTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer jarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/typeargument_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/typeargument_app", "main"))
