...
public class MetadataRewriteInNestedClassTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer nestedLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/nested_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/nested_app", "main"))
