...
public class MetadataRewriteInTypeAliasTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer typeAliasLibJarMap =
      getCompileMemoizer(
          getKotlinSourceFileFromResources(PKG_PREFIX + "/typealias_lib", "lib"),
          getKotlinSourceFileFromResources(PKG_PREFIX + "/typealias_lib", "lib_ext"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/typealias_app", "main"))
