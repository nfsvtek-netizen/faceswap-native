...
public class MetadataRewriteInSuperTypeTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer superTypeLibJarMap =
      getCompileMemoizer(
          getKotlinSourceFileFromResources(PKG_PREFIX + "/supertype_lib", "impl"),
          getKotlinSourceFileFromResources(PKG_PREFIX + "/supertype_lib" + "/internal", "itf"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/supertype_app", "main"))
