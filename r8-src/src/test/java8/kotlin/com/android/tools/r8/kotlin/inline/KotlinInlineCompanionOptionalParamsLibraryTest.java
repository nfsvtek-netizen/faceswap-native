...
public class KotlinInlineCompanionOptionalParamsLibraryTest extends KotlinInlineTestBase {

  public KotlinInlineCompanionOptionalParamsLibraryTest(
      TestParameters parameters, KotlinTestParameters kotlinParameters) {
    super(kotlinParameters, "companion_optional_params");
