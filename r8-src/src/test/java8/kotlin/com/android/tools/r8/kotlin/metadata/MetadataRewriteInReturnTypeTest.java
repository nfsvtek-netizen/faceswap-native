...
public class MetadataRewriteInReturnTypeTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer returnTypeLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/returntype_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/returntype_app", "main"))
