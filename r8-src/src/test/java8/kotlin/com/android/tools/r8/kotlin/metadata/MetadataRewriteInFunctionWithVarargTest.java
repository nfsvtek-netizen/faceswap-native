...
public class MetadataRewriteInFunctionWithVarargTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer varargLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/vararg_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/vararg_app", "main"))
