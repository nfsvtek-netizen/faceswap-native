...
public class MetadataRewriteInSealedClassTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer sealedLibJarMap =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/sealed_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/sealed_app", "valid"))
