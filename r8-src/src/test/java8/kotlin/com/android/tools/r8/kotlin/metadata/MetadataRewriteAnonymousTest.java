...
public class MetadataRewriteAnonymousTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer libJars =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/anonymous_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinParameters)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/anonymous_app", "main"))
