...
public class MetadataRewriteInlineClassTest extends KotlinMetadataTestBase {
  ...
  private static final KotlinCompileMemoizer libJars =
      getCompileMemoizer(getKotlinSourceFileFromResources(PKG_PREFIX + "/inline_class_lib", "lib"));
  ...
  public void smokeTest() throws Exception {
    ...
    Path output =
        kotlinc(parameters.getRuntime().asCf(), kotlinc, targetVersion, lambdaGeneration)
            ...
            .addSourceFiles(getKotlinSourceFileFromResources(PKG_PREFIX + "/inline_class_app", "main"))
