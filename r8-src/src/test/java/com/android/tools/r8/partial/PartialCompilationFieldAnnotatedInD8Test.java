...
public class PartialCompilationFieldAnnotatedInD8Test extends TestBase {
  ...
  public void testR8() throws Exception {
    testForR8(parameters.getBackend())
        .setMinApi(parameters)
        .addProgramClasses(Annotation.class, AnnotatedClass.class, Main.class)
        .addKeepFieldRules(Reference.fieldFromField(AnnotatedClass.class.getDeclaredField("field")))
  ...
  public static class AnnotatedClass {
    @Annotation private int field;

    void method() throws Exception {
      System.out.println(AnnotatedClass.class.getDeclaredField("field").getAnnotations().length);
    }
  }
