...
public class R8PartialNativeMethodsTest extends TestBase {
  @Parameters(name = "{0}")
  ...
  public R8PartialNativeMethodsTest(TestParameters parameters) {
  ...
  public void test() throws Throwable {
    ...
    testForR8Partial(Backend.DEX)
        ...
        .setR8PartialConfiguration(
            builder -> builder.includeAll().excludeClasses(Class1.class, Class2.class))
  ...
  public void testAllowRenamingNatives() throws Throwable {
    ...
    testForR8Partial(Backend.DEX)
        ...
        .addProgramFiles(inputJar)
        .addProgramClasses(Main.class)
        .setR8PartialConfiguration(builder -> builder.includeAll().excludeClasses(Main.class))
        .setNativeReferencesConsumer(nativeReferencesConsumer)
        .compile()
        .inspect(
            inspector -> {
