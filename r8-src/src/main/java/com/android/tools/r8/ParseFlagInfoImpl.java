...
import static com.android.tools.r8.BaseCompilerCommandParser.API_DATABASE_FLAG;
...
public class ParseFlagInfoImpl implements ParseFlagInfo {
  ...
  public static ParseFlagInfoImpl getApiDatabase() {
    return flag1(
        API_DATABASE_FLAG,
        "<file>",
        "Use <file> as the Android API database for API modeling,",
        "overriding the default database.",
        "<file> must be a .ser file generated by ApiDatabaseGenerator.");
  }
