...
.method public static addTransitionTargets(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/FragmentTransitionCompat21$ViewRetriever;Landroid/view/View;Landroid/support/v4/app/FragmentTransitionCompat21$EpicenterView;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    .line 145
    .local v12, "exitTransition":Landroid/transition/Transition;
    move-object/from16 v13, p1

    check-cast v13, Landroid/transition/Transition;

    .line 146
    .local v13, "sharedElementTransition":Landroid/transition/Transition;
    const/4 v0, 0x1

    move-object/from16 v14, p9

    invoke-static {v11, v12, v14, v0}, Landroid/support/v4/app/FragmentTransitionCompat21;->excludeViews(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    .line 149
    invoke-virtual {v11, v9}, Landroid/transition/Transition;->addTarget(Landroid/view/View;)Landroid/transition/Transition;
    ...
    invoke-static {v13, v9, v15, v10}, Landroid/support/v4/app/FragmentTransitionCompat21;->setSharedElementTargets(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V

    .line 154
    invoke-static {v11, v13, v10, v0}, Landroid/support/v4/app/FragmentTransitionCompat21;->excludeViews(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    .line 155
    invoke-static {v12, v13, v10, v0}, Landroid/support/v4/app/FragmentTransitionCompat21;->excludeViews(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    new-instance v7, Landroid/support/v4/app/FragmentTransitionCompat21$2;
...
.method public static cleanupTransitions(Landroid/view/View;Landroid/view/View;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    .line 389
    .local v14, "sharedElementTransition":Landroid/transition/Transition;
    move-object/from16 v15, p8

    check-cast v15, Landroid/transition/Transition;

    .line 390
    .local v15, "overallTransition":Landroid/transition/Transition;
    if-eqz v15, :cond_0
    ...
    new-instance v10, Landroid/support/v4/app/FragmentTransitionCompat21$4;
    ...
    .end local v12    # "enterTransition":Landroid/transition/Transition;
    .local v16, "enterTransition":Landroid/transition/Transition;
    move-object v10, v15
    ...
    .end local v13    # "exitTransition":Landroid/transition/Transition;
    ...
    invoke-virtual {v13, v12}, Landroid/view/ViewTreeObserver;->addOnPreDrawListener(Landroid/view/ViewTreeObserver$OnPreDrawListener;)V

    goto :goto_0

    .line 390
    .end local v16    # "enterTransition":Landroid/transition/Transition;
    .end local v17    # "exitTransition":Landroid/transition/Transition;
    .restart local v12    # "enterTransition":Landroid/transition/Transition;
    .restart local v13    # "exitTransition":Landroid/transition/Transition;
    :cond_0
    move-object/from16 v16, v12
    ...
    .end local v12    # "enterTransition":Landroid/transition/Transition;
    .end local v13    # "exitTransition":Landroid/transition/Transition;
    .restart local v16    # "enterTransition":Landroid/transition/Transition;
