...
.method public constructor <init>(Landroid/support/v4/app/BackStackRecord;)V
    ...
    .end local v5    # "pos":I
    .local v6, "pos":I
    iget-object v7, v1, Landroid/support/v4/app/BackStackRecord$Op;->removed:Ljava/util/ArrayList;
    ...
    .line 81
    :cond_5
    iget v3, p1, Landroid/support/v4/app/BackStackRecord;->mTransition:I

    iput v3, p0, Landroid/support/v4/app/BackStackState;->mTransition:I

    .line 82
    iget v3, p1, Landroid/support/v4/app/BackStackRecord;->mTransitionStyle:I

    iput v3, p0, Landroid/support/v4/app/BackStackState;->mTransitionStyle:I

    .line 83
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->mName:Ljava/lang/String;

    iput-object v3, p0, Landroid/support/v4/app/BackStackState;->mName:Ljava/lang/String;

    .line 84
    iget v3, p1, Landroid/support/v4/app/BackStackRecord;->mIndex:I

    iput v3, p0, Landroid/support/v4/app/BackStackState;->mIndex:I

    .line 85
    iget v3, p1, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbTitleRes:I

    iput v3, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbTitleRes:I

    .line 86
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbTitleText:Ljava/lang/CharSequence;

    iput-object v3, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbTitleText:Ljava/lang/CharSequence;

    .line 87
    iget v3, p1, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbShortTitleRes:I

    iput v3, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbShortTitleRes:I

    .line 88
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->mBreadCrumbShortTitleText:Ljava/lang/CharSequence;

    iput-object v3, p0, Landroid/support/v4/app/BackStackState;->mBreadCrumbShortTitleText:Ljava/lang/CharSequence;

    .line 89
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->mSharedElementSourceNames:Ljava/util/ArrayList;

    iput-object v3, p0, Landroid/support/v4/app/BackStackState;->mSharedElementSourceNames:Ljava/util/ArrayList;

    .line 90
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->mSharedElementTargetNames:Ljava/util/ArrayList;

    iput-object v3, p0, Landroid/support/v4/app/BackStackState;->mSharedElementTargetNames:Ljava/util/ArrayList;
...
.method public instantiate(Landroid/support/v4/app/FragmentManagerImpl;)Landroid/support/v4/app/BackStackRecord;
    ...
    iput v5, v3, Landroid/support/v4/app/BackStackRecord$Op;->enterAnim:I
    ...
    iput v5, v3, Landroid/support/v4/app/BackStackRecord$Op;->popEnterAnim:I
    ...
    iget-object v9, v3, Landroid/support/v4/app/BackStackRecord$Op;->removed:Ljava/util/ArrayList;
